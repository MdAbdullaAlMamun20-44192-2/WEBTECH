                            ...
                            <div class="col-md-6 col-xl-4 text-center" style="margin-left: 275px;margin-right: 250px;">
                                <div class="card mb-5" style="background-color: rgba(0, 0, 0, 0.5);">
                                    <div class="card-body d-flex flex-column align-items-center"
                                        ...
                                        <form action="../../../Controller/Adopter/Login_Handler.php" class="text-center"
                                            method="post">

                                            <!-- Mail -->
                                            <div class="mb-3"><input class="form-control" type="text" name="mail"
                                                    id="mail" placeholder="Email"
                                                    value="<?php if ($cookie_mail != "") {
                                                                                                                                                            echo $cookie_mail;
                                                                                                                                                        } ?>">
                                            ...
                                            <div class="form-check"><input class="form-check-input" name="rememberMe"
                                                    ...
                                                    style="color: white;">Remember Me?</label></div>

                                            <!-- Forget Password -->
                                            <p class="text-muted"><a
                                                    href="../../Adopter/Forget_Password/ForgetPassword/ForgetPassword.php">Forgot
                                                    your password?</a>
                                            </p>
                                            <label class="form-check-label" style="color: white;">Didn't have
                                                account?</label> <span class="text-muted">
                                                <a href="../../Adopter/SignUp/SignUp.php">Signup</a>
