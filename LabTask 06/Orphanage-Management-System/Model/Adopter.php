...
// {
//     $conn = db_conn();
//     $selectQuery = "INSERT into adopter (adopter_mail, password, adopter_name, adopter_phone, adopter_image, adopter_profession, 
//     adopter_gender, adopter_address, adoption_status)
//     VALUES (:adopter_mail, :password, :adopter_name, :adopter_phone, :adopter_image, :adopter_profession, 
//     :adopter_gender, :adopter_address, :adoption_status)";
//     try {
//         $stmt = $conn->prepare($selectQuery);
//         $stmt->execute([
