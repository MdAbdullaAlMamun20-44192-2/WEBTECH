        ...
        <div class="right">
            ...
            <form id="reqID_form" action="../../Controller/Supervisor/AdoptionRequest_Handler_Accept.php" method="POST">
                ...
                foreach ($data as $row) {
                    ...
                    echo '<td><span class="appoint">  <a class="button-appoint" name="accept" id="accept" onclick="openOverlay()" value="' . $row["request_id"] . '"> Appoint</a>
                    <input type="radio" name="accept" id="accept"  value="' . $row['request_id'] . '" style="display: none">
                    </span>
            ...
            <div id="overlay">
                <div class="content">
                    <h2>Select Date</h2>
                    <form action="../../Controller/Supervisor/AdoptionRequest_Handler_Accept.php" method="POST" onsubmit="return checkDate();" id="date_form">
